...
public class HelperFunctions {
	...
	public static class Scanners {
		 ...
		 * @param r - The radius of the square (from center) to look in
		 * @param blockList - The blocks to look for
		 * @param includeCenter - Should the center be evaluated
		 ...
		 * @param worldIn - The world to look in
		 * @param center - The position of the center
		 * @param r1 - The radius of the square (from north of center) to look in
		 * @param r2 - The radius of the square (from west of center) to look in
		 * @param blockList - The blocks to look for
		 * @param includeCenter - Should the center be evaluated
		 * @return A BlockPos list of blocks found
		 */
		public  static ArrayList<BlockPos> scanRadiusFor(World worldIn, BlockPos center, int r1, int r2, Block[] blockList,
				boolean includeCenter) {
			ArrayList<BlockPos> newList = new ArrayList<BlockPos>();
			int d1 = r1*2+1;
			int d2 = r2*2+1;
	...
	public static class Locators {
		 ...
		 * @param pos
		 * @param blockList
		 * @return Whether or not the block at the position is covered by the block(s) given
		 */
